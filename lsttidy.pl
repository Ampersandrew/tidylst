...
sub FILETYPE_parse {
   ...
   for my $thisLine (@ {$lines_ref} ) {
      ...
      additionnalLineParsing($curent_linetype, \%line_tokens, $file, $line, $newline);
...
#           $line_ref         Ref to a hash containing the tags of the line
...
BEGIN {
   ...
   sub additionnalLineParsing {
      ...
      my ( $filetype, $line_ref, $file_for_error, $line_for_error, $line_info ) = @_;
